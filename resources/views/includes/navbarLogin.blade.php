<nav class="navbar navbar-light navbar-expand-md" id="barraNav">
    <div class="container-fluid"><img id="cheems1" src="assets/img/cheems.png"><a class="navbar-brand" id="logo" href="{{ route('vistaIndice') }}">CheemsTube</a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
        <div class="collapse navbar-collapse" id="navcol-1">
            <ul class="navbar-nav">
                ...
                <li class="nav-item"><a class="nav-link" id="itemBarra" href="#">si</a></li>
            </ul>
            <ul class="navbar-nav text-center ms-auto px-5" id="nav2">
                ...
                <li class="nav-item dropdown"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" id="linkMiCuenta" href="#" style="color: rgb(255,255,255);">Mi cuenta</a>
                    <div class="dropdown-menu dropdown-menu-dark"><a class="dropdown-item" href="#">Mi cuenta</a>
