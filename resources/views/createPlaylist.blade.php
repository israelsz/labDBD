        ...
        @auth
            ...
            <section class="m-5 d-lg-flex d-xl-flex justify-content-lg-center align-items-lg-center justify-content-xl-center align-items-xl-center" style="filter: grayscale(0%) saturate(72%);border-style: none;border-top-style: none;border-bottom-width: 1px;">
                <div class="row" style="background: rgb(30,40,51);border-radius: 4px;transform-origin: center;">
                    <form  action="{{route('agregarListaReproduccion')}}" method="POST">
                        @method('post')
                        <h4 class="m-3" style="color: var(--bs-light)">Nombre de la lista de reproducción</h4>
                        <input name="playlist_name" class="form-control mb-3" type="text" style="color: var(--bs-light);background: rgba(255,255,255,0);border-radius: 0px;border-style: none;border-bottom-style: solid;border-bottom-color: rgb(67,74,82);weidgh;width: 230px;height: 27px;" placeholder="Ingrese nombre de la lista de reproduccion">
                        <h4 class="m-3" style="color: var(--bs-light)">Ingrese descripccion de la lista de reproduccion</h4>
                        <div class="form-floating mb-5">
                            <input name="playlist_description" class="form-control" id="floatingTextarea" style="color: var(--bs-light);background: rgba(255,255,255,0);border-radius: 0px;border-style: none;border-bottom-style: solid;border-bottom-color: rgb(67,74,82);">
                        </div>
                        ...
                        @foreach ($videos as $video)
                            <li class="list-group-item" style="background: rgba(255,255,255,0)">
                                <input class="form-check-input me-1"  type="checkbox" value="{{$video}}">
                                <iframe id="videoIframe" src="{{$video->direccion_video}}"  title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            </li>    
                        @endforeach
                        </ul>
                    </form>
